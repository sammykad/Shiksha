...
import { ArrowLeftIcon, CheckIcon, SortAsc, Upload } from "lucide-react"
import {
    FileUpload,
    FileUploadDropzone,
    FileUploadList,
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            {step === "upload" ? (
                <DialogContent className="p-8 sm:max-w-xl">
                    ...
                    >
                        <FileUploadDropzone className="flex flex-col items-center justify-center border-2 border-dashed border-muted-foreground/25 bg-muted/50 py-12 transition-colors hover:bg-muted/80">
                ...
                <Popover open={open} onOpenChange={setOpen}>
                    <PopoverTrigger asChild>
                        ...
                        >
                            ...
                            <SortAsc className="ml-2 size-4 shrink-0 opacity-50" />
                        </Button>
                    </PopoverTrigger>

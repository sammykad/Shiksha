...
export default function CardFlip({
  ...
  // Show image only when imageSrc is provided AND image hasn't errored
        ...
        >
          <div className="relative h-full overflow-hidden bg-gradient-to-b from-zinc-100 to-white dark:from-zinc-900 dark:to-black">
            {showImage ? (
              ...
              /* No image or broken image: show animation */
          ...
          <div className="absolute bottom-0 left-0 right-0 p-5">
            <div className="flex items-center justify-between gap-3">
              <div className="space-y-1.5">
                <h2
                  className={cn(
                    'text-lg font-semibold leading-snug tracking-tighter transition-all duration-500 ease-out-expo group-hover:translate-y-[-4px]',
                    showImage
                ...
                <p
                  className={cn(
                    'text-sm line-clamp-2 tracking-tight transition-all duration-500 ease-out-expo group-hover:translate-y-[-4px]',
                    showImage
              ...
              <div className="relative group/icon">
                ...
                <Repeat2
                  className={cn(
                    ...
                    showImage ? 'text-white' : 'text-orange-500'
                  )}
                />
              </div>
            </div>
        ...
        >
          <div className="flex-1 space-y-6">
            <div className="space-y-2">
              {/* <h2 className="text-lg font-semibold text-zinc-900 dark:text-white leading-snug tracking-tight transition-all duration-500 ease-out-expo group-hover:translate-y-[-2px]">
                {title}
              </h2> */}

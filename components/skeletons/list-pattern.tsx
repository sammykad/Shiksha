...
export function ListPatternSkeleton({ count = 4, hasAvatar = true, className }: ListPatternProps) {
    return (
...
export function ListCardPatternSkeleton({ count = 3, className }: { count?: number; className?: string }) {
    return (

...
const NODES: NodeConfig[] = [
  { id: 'A', x: 50, y: 120, icon: MessageCircle, label: "REQUEST", type: 'box' },
  ...
  { id: 'D', x: 280, y: 190, icon: Terminal, label: "TOOLS", type: 'box' },
];
                ...
                {isBox && node.icon ? (
                  ...
                  >
                    ...
                    <div className="mb-0.5 flex items-center justify-center">
                      <node.icon className="w-5 h-5 fill-current" />
                    </div>
...
const STATUS_ICONS: Record<string, { icon: any; color: string; bg: string; gradient: string; border: string }> = {
  ...
  running: { icon: Loader2, color: "text-blue-400", bg: "bg-blue-400/15", gradient: "bg-gradient-to-b from-blue-400 to-blue-600", border: "border-blue-600" },
          ...
          >
            <div className={`w-full rounded-2xl border flex items-center gap-2.5 ${isActive
              ...
              <div className={`shrink-0 rounded-[8px] flex items-center justify-center font-bold text-white transition-all duration-300 ${si.gradient} border ${si.border} shadow-[inset_0_0.5px_0_0_rgba(255,255,255,0.6),inset_0.5px_0_0_0_rgba(255,255,255,0.2),inset_0_2px_6px_0_rgba(255,255,255,0.3),inset_0_-0.5px_0_0_rgba(0,0,0,0.3),inset_-0.5px_0_0_0_rgba(0,0,0,0.1),inset_0_-2px_6px_0_rgba(0,0,0,0.1),0_1px_2px_0_rgba(0,0,0,0.08),0_2px_4px_0_rgba(0,0,0,0.06),0_4px_6px_0_rgba(0,0,0,0.04)] ${isActive ? "w-8 h-8" : "w-5 h-5"
                ...
                <si.icon className={`${isActive ? "w-4 h-4" : "w-2.5 h-2.5"} ${l.status === "running" ? "animate-spin" : ""}`} />
              </div>
      ...
      <div className="flex-1 flex flex-col gap-0 min-w-0 pr-2">
        ...
        <div className="flex flex-col gap-3 flex-1">
          {namespaces.map((ns, i) => {
            ...
            const Icon = (NS_ICONS[ns.name] || Database) as React.ComponentType<{ size?: number; className?: string; fill?: string }>;
            ...
            return (
              <div key={ns.name} className="flex items-center gap-3 group relative">
                ...
                >
                  <Icon size={16} className="relative z-10" fill={isActive ? "currentColor" : "none"} />
                </div>
...
export function Card5() {
  const tools = [
    ...
    { name: "code_exec", calls: 8, icon: Terminal, latency: "1.2s", color: "bg-gradient-to-b from-emerald-400 to-emerald-600", borderColor: "border-emerald-600" },
          ...
          >
            ...
            <div className="flex items-start justify-between">
              <div className={`w-[28px] h-[28px] rounded-[8px] flex items-center justify-center text-white ${t.color} border ${t.borderColor} shadow-[inset_0_0.5px_0_0_rgba(255,255,255,0.6),inset_0.5px_0_0_0_rgba(255,255,255,0.2),inset_0_2px_6px_0_rgba(255,255,255,0.3),inset_0_-0.5px_0_0_rgba(0,0,0,0.3),inset_-0.5px_0_0_0_rgba(0,0,0,0.1),inset_0_-2px_6px_0_rgba(0,0,0,0.1),0_1px_2px_0_rgba(0,0,0,0.08),0_2px_4px_0_rgba(0,0,0,0.06),0_4px_6px_0_rgba(0,0,0,0.04)] group-hover:scale-105 transition-transform duration-300`}>
                <t.icon className="w-3.5 h-3.5 relative z-10 fill-current" />
              </div>
...
const CARDS = [
  {
    title: "FeeSense AI",
    description: "Detect overdue fees, analyse payment patterns, and assess risk levels automatically.",
    visual: <Card1 />,
  ...
  {
    title: "Attendance AI",
    description: "Spot absentee patterns, frequent lateness, and flag students needing intervention.",
    visual: <Card2 />,
    colSpan: "lg:col-span-1",
    height: "h-[260px]",
  },
  {
    ...
    description: "Real-time feed of AI agent actions — reminders sent, patterns detected, alerts triggered.",
    visual: <Card3 />,
    colSpan: "lg:col-span-1",
    height: "h-[260px]",
  },
  {
    ...
    description: "Connect fees, attendance, exams, and notices — one unified knowledge graph for your school.",
    visual: <Card4 />,
  ...
  },
  {
    ...
    description: "Multi-channel notifications — WhatsApp, SMS, email, push — triggered intelligently by AI agents.",
    visual: <Card5 />,
    colSpan: "lg:col-span-1",
    height: "h-[260px]",
  }

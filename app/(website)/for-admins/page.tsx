...
const softwareSchema = {
  ...
  name: 'Shiksha Cloud Admin Dashboard',
  ...
  audience: {
    '@type': 'Audience',
    audienceType: 'School administrators, principals, and institute owners in India',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'For Admins', item: `${appUrl}${role.href}` },
  ],
};
